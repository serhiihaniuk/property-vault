...
export function InviteAcceptanceWidget({ token }: InviteAcceptanceWidgetProps) {
  ...
  const isLoading = invitationQuery.isPending
  const invitationErrorMessage = invitationQuery.error
    ...
    <Surface className="w-full max-w-xl" tone="elevated">
        ...
        <SurfaceHeading>
          ...
          <SurfaceDescription>
            {invitation ? (
              ...
              "Create your password to activate access from this private invite link."
            )}
          </SurfaceDescription>
        </SurfaceHeading>
        {invitation ? (
      ...
      <SurfaceBody className="gap-4">
        {isLoading ? (
          ...
          <ErrorState
            title="Invitation unavailable"
            description="The invitation details are unavailable."
          />
        )}
      </SurfaceBody>
    </Surface>
