...
**Last updated:** 2026-04-17 18:37 Europe/Warsaw
**Owner:** Serhii
...
| 4 | Manual extraction loop | [~] | 22 real records are stored; broader backfill leaves 8 documents in the extraction queue. Fixture families for media_settlement, interest_note, account_statement still missing. |
...
- Continue broader-backfill extraction queue; 8 documents remain after
  extracting `41cd380...`.
...
Updated 2026-04-17 after extracting the September 2025 monthly charge notice.
...
- Current records: 22.
- Current extraction queue: 8 documents.
- New broader-backfill extraction completed this step:
  `41cd380...` September 2025 monthly charge notice (`monthly_charges`, `ok`):
  charge schedule effective 2025-09-01, total monthly charge 401.13 PLN, rows
  sum exactly to the stated total and the notice shows zero balances on issue
  date.
...
- `EXTRACTION_MISSING` - 8 documents from the broader Gmail backfill still
