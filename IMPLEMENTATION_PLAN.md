...
**Last updated:** 2026-04-17 18:41 Europe/Warsaw
**Owner:** Serhii
...
| 4 | Manual extraction loop | [~] | 17 real records are stored; broader backfill leaves 13 documents in the extraction queue. Fixture families for media_settlement, interest_note, account_statement still missing. |
...
- `8bd2a7d` Record 2024 shared-property settlement extraction.
- `e90e2bd` Record late-payment interest extraction.
- `58f872f` Record second-half 2024 media settlement extraction.
- `1de5c04` Record DACH BUD resolution ballot extraction.
...
- Continue broader-backfill extraction queue; 13 documents remain after
  extracting `6cbaab2...`.
...
Updated 2026-04-17 after extracting the 2024 shared-property annual-cost settlement.
...
- Current records: 17.
- Current extraction queue: 13 documents.
- New broader-backfill extraction completed this step:
  `6cbaab2...` 2024 shared-property annual-cost settlement
  (`shared_property_settlement`, `needs_review`): total costs 1,153.69 PLN,
  revenues 126.22 PLN, settlement result 41.94 PLN, payment deadline
  2025-03-31; the "Do zaplaty 985,53" line is ambiguous in the source.
...
- `EXTRACTION_MISSING` - 13 documents from the broader Gmail backfill still
