...
**Last updated:** 2026-04-17 18:29 Europe/Warsaw
**Owner:** Serhii
...
| 4 | Manual extraction loop | [~] | 11 real records are stored; broader backfill leaves 19 documents in the extraction queue. Fixture families for media_settlement, interest_note, account_statement still missing. |
...
- Continue broader-backfill extraction queue; 19 documents remain after
  extracting `9524aaf...`.
...
Updated 2026-04-17 after extracting the first-half 2024 media settlement.
...
- `reports/inbox.md` up to date; 32 open anomalies.
- Current records: 11.
- Current extraction queue: 19 documents.
- New broader-backfill extraction completed this step:
  `9524aaf...` media settlement for 2024-04-30 through 2024-06-30
  (`media_settlement`, `ok`, water/sewage usage 3.907 m3, net media
  overpayment 173.44 PLN, booked 2024-08-31).
...
- `EXTRACTION_MISSING` - 19 documents from the broader Gmail backfill still
