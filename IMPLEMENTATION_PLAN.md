...
**Last updated:** 2026-04-17 17:54 Europe/Warsaw
**Owner:** Serhii
...
| 4 | Manual extraction loop | [~] | 6 real records are stored; broader backfill leaves 24 documents in the extraction queue. Fixture families for media_settlement, interest_note, account_statement still missing. |
...
- Continue broader-backfill extraction queue; 24 documents remain after
  extracting `7ceb789d...`.
...
Updated 2026-04-17 after extracting the community-member data declaration.
...
- `reports/inbox.md` up to date; 35 open anomalies.
- Current records: 6.
- Current extraction queue: 24 documents.
- New broader-backfill extraction completed this step:
  `7ceb789d...` blank community-member data declaration and GDPR information
  (`correspondence`, `ok`).
...
- `EXTRACTION_MISSING` - 24 documents from the broader Gmail backfill still
