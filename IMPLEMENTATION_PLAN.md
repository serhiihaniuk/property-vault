...
| 4 | Manual extraction loop | [~] | 16 real records are stored; broader backfill leaves 14 documents in the extraction queue. Fixture families for media_settlement, interest_note, account_statement still missing. |
...
- Continue broader-backfill extraction queue; 14 documents remain after
  extracting `4ee8cbe...`.
...
Updated 2026-04-17 after extracting the 2024 shared-property settlement.
...
- Current records: 16.
- Current extraction queue: 14 documents.
- New broader-backfill extraction completed this step:
  `4ee8cbe...` 2024 shared-property settlement (`shared_property_settlement`,
  `needs_review`): total costs 1,153.69 PLN, revenues 126.22 PLN, settlement
  result 41.94 PLN, payment deadline 2025-03-31; the "Do zaplaty 985,53" line
  is ambiguous in the source.
...
- `EXTRACTION_MISSING` - 14 documents from the broader Gmail backfill still
