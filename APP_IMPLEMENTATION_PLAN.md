...
| `T48` | Fix live dashboard copy and encoding drift | `todo` | `T46`, `T47` | live dashboard copy/formatting sources only | `gpt-5.4-mini / medium` | `hardening-c3` | `standard` | live dashboard status/copy no longer shows mojibake or corrupted punctuation, without redesigning the dashboard shell |
